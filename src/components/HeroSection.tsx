...
export const HeroSection = () => {
  return (
    <section className="relative min-h-[85vh] flex items-center justify-center py-8 sm:py-12 lg:py-16 xl:py-20 bg-gradient-to-br from-blue-50 via-white to-purple-50 overflow-hidden">
      ...
      <div className="container relative mx-auto text-center px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div className="space-y-6 sm:space-y-8 lg:space-y-10">
          ...
          {/* Main heading */}
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight text-gray-900 leading-tight px-2 sm:px-0">
          ...
          <div className="pt-6 sm:pt-8 lg:pt-12">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4 lg:gap-6 items-center justify-center max-w-5xl mx-auto">
              <div className="flex items-center justify-center space-x-1 sm:space-x-2 text-gray-600 p-2">
              ...
              <div className="flex items-center justify-center space-x-1 sm:space-x-2 text-gray-600 p-2">
                <Shield className="w-3 h-3 sm:w-4 sm:h-4 lg:w-5 lg:h-5 flex-shrink-0" />
              ...
              <div className="flex items-center justify-center space-x-1 sm:space-x-2 text-gray-600 p-2">
                <Sparkles className="w-3 h-3 sm:w-4 sm:h-4 lg:w-5 lg:h-5 flex-shrink-0" />
                <span className="text-xs sm:text-sm font-medium">AI-Powered</span>
              </div>
              <div className="flex items-center justify-center space-x-1 sm:space-x-2 text-gray-600 p-2 col-span-2 sm:col-span-1">
