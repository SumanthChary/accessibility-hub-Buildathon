...
export const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center py-20 px-4 bg-gradient-to-br from-blue-50 via-white to-purple-50 overflow-hidden">
      ...
      <div className="container relative mx-auto text-center max-w-6xl">
        <div className="space-y-8 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-6">
            <Button
              size="lg"
              className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 text-lg rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200"
              onClick={() => {
            ...
            <Button
              size="lg"
              variant="outline"
              className="w-full sm:w-auto px-8 py-4 text-lg rounded-xl border-2 hover:bg-gray-50"
              onClick={() => {
          ...
          <div className="pt-16">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-6 items-center justify-center max-w-4xl mx-auto">
              <div className="flex items-center justify-center space-x-2 text-gray-600 p-3">
              ...
              <div className="flex items-center justify-center space-x-2 text-gray-600 p-3 col-span-2 sm:col-span-1">
